...
router.get("/settlements", auth.authAdmin, adminController.listSettlements);
router.patch("/settlements/:id/settle", auth.authAdmin, adminController.settleCommission);
router.get("/promo-codes", auth.authAdmin, adminController.listPromoCodes);
router.post("/promo-codes", auth.authAdmin, adminController.createPromoCode);
