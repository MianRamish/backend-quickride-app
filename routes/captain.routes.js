...
const captainReadController = require("../controllers/captain.read.controller");
...
router.get("/profile", authCaptain, captainReadController.profile);
...
router.get("/performance", authCaptain, captainReadController.performance);
